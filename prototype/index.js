...
// var resultString = text.generate(["Lorem Ipsum - це; текст-\"р;иба\", що вико;ристовується в", " друкарстві та д;изайні.; Lorem Ipsum; є, фактично, стан", "дартною \"рибо;ю\" аж з XVI сторіч;чя, коли невідо;мий друкар "]);
// console.log(resultString);
...
CsvArray.prototype.generate = function(){
